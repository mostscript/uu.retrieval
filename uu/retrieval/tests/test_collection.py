...
class TestCollection(unittest.TestCase):
    ...
    def test_set_difference(self):
        ...
        assert set(collection4.keys()) == set(collection1.keys()) # nothing removed
    ...
    def test_set_intersection(self):
        ...
        assert set((collection1 & collection2).keys()) == set(collection1.keys())
...
class TestNamedCollection(unittest.TestCase):
    ...
    def test_construction(self):
        ...
        collection = BaseNamedCollection(ITEMS, NAMES)  # succeeds w/ names
    ...
    def test_setops(self):
        ...
        assert set((collection1 & collection2).keys()) == set(collection1.keys())
        assert set((collection2 | collection1).keys()) == set(collection2.keys())
        assert set(collection2.keys()) == set(namemap.keys())  # sufficient test
